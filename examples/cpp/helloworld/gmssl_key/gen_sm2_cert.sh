#!/bin/sh
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/luodahui/.local/TAGMSSL/lib
OPENSSL_DIR=/home/luodahui/.local/GMTASSL
CERT_DIR=./cert/

# Path to the openssl program
OPENSSL_CMD=$OPENSSL_DIR/bin/gmtassl
